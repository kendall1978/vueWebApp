...
<div>
  <b-card-group columns>
    ...
    <b-card title="Title" id="blogCard"
    img-src="https://placekitten.com/500/350" img-alt="Image" img-top>
      <b-card-text>
    ...
    <b-card img-src="https://picsum.photos/400/200/?image=41" id="blogCard"
